...
3. With that background we will tackle our exploration of Snakemake's use of (end of sentence missing here)
...
```r
use_condaenv(condaenv = "/projects/eriq@colostate.edu/mambaforge/envs/snakemake-8.5.3")
```
